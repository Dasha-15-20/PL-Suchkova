...
# y = 4.642*10**(-2)
# z = 21
# s = math.log(y**(-1*math.sqrt(abs(x))), math.e) \
# * (x - y/2) + math.sin(math.atan(z))**2
# print(s)
...
# y = 2.23
# z = 15.221
# s = (math.e**abs(x - y) * abs(x - y)**(x + y)) \
# / (math.atan(x) + math.atan(z)) \
# + (x**6 + math.log(y, math.e)**2)**(1/3)
# print(s)
...
# y = 10.365*10**(-3)
# z = 0.828*10**5
# s = (y + (x - 1)**(1/3))**(1/4)/(abs(x - y) \
# * (math.sin(z)**2 + math.tan(z)))
# print(s)
...
# z = -0.13*10**3
# s = (x**(y + 1) + math.e**(y - 1)) \
# / (1 + x * abs(y - math.tan(z))) * (1+abs(y-x)) \
